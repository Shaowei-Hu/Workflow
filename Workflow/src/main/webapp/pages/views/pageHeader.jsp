            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="getMyInformation.action"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li><a href="getAllTeachers.action"><i class="fa fa-user fa-fw"></i> Theachers<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="getAllTeachersAdminT.action"><i class="fa fa-table fa-fw"></i> Tables</a>
                                </li>
                                <li>
                                    <a href="getAllTeachersAdminG.action"><i class="fa fa-picture-o fa-fw"></i> Graphics</a>
                                </li>
						...
						<li><a href="getMyInformation.action"><i class="fa fa-edit fa-fw"></i> Modify<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="#"><i class="fa fa-university"></i> Cours</a>
                                </li>
                                <li>
                                    <a href="getAllTeachersAdminOperation.action"><i class="fa fa-user"></i> Teacher</a>
                                </li>
